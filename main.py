...
def main(modes, control = -1):
    ...
    match control:
        ...
        case 2:
            ...
            sim.simulate_architecture(modes, angles, parallel_modes_list, nTbW, nTbH, 0, 0, 64, 64, subset_size_x, subset_size_y, refidx = 0, samples_on = samples_on , reuse_on = reuse_on)
