...
def main(modes, control = -1):
    ...
    match control:
        ...
        case 2:
            ...
            sim.simulate_list_of_states(modes, angles, parallel_modes_list, nTbW, nTbH, 0, 0, 8, 8, subset_size_x, subset_size_y, refidx = 0, samples_on = samples_on , reuse_on = reuse_on)
